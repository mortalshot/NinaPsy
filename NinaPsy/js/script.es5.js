...
var articleSidebar = $('#sidebar__wrapper');
var wrapper = $('body');
var headerWithLockPadding = $('.header.lock-padding').height();

if (articleSidebar.length > 0) {
  var articleSidebarOffset = articleSidebar.offset().top - headerWithLockPadding;
  var asideFixedTopClassName = 'aside-fixed-top';
  var asideFixedBottomClassName = 'aside-fixed-bottom';
  var articleSidebarHeight = articleSidebar.height();
  var articleSidebarWidth = articleSidebar.width(); // article sidebar sticky
  ...
  if ($(window).width() > 575) {
    $(window).scroll(function () {
      ...
      var bottomFixPoint = $(document).height() - 25 - (articleSidebar.height() + headerWithLockPadding * 2 + $('.footer').height());
